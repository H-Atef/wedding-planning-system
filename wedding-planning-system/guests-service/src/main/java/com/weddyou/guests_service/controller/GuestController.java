...
public class GuestController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public  List<GuestResponse>getUserGuestList(@PathVariable(value = "user-id",required = false) Long userId){
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public  void addGuestForUser(@Valid @PathVariable(value = "user-id",required = false) Long userId,
                                 @RequestBody GuestRequest guestRequest){
